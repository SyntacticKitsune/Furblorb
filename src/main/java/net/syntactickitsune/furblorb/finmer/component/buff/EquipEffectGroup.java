package net.syntactickitsune.furblorb.finmer.component.buff;
...
public final class EquipEffectGroup implements IFurballSerializable {
	...
	public EquipEffectGroup(Decoder in) {
		...
		buffs.addAll(FurballUtil.readObjectList21(in, "Buffs", FurballSerializables::read));
	}
	...
	public void write(Encoder to) {
		...
		FurballUtil.writeObjectList21(to, "Buffs", buffs, Buff::writeWithId);
	}
